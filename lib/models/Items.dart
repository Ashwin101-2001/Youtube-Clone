...
class Item {
 ...
 // String videoTitle;
  ...
  Item({this.thumbnail, this.viewCount,this.uploadDate,  this.channel,this.vid,this.type,this.title}) ;
  ...
  String getVideoTitle() {
    ...
    if (this.title.length > 29) {
      // fix title
      List wordList = this.title.split(" ");
      String newTitle = "";
  ...
  factory Item.fromMap(Map<String, dynamic> map,String x) {
    print('in map');

    String z;
    if(map['id']['kind'].toString().substring(8)=='video')
    { z='video';

    }
    if(map['id']['kind'].toString().substring(8)=='playlist')
    { z='playlist';

    }
    if(map['id']['kind'].toString().substring(8)=='channel')
    { z='channel';

    }
    String k='${z}Id';
    NetworkImage y=NetworkImage(map['snippet']['thumbnails']['high']['url']);

    return Item(
      //videoTitle: map['snippet']['title'],
      ...
      channel:
      Channel(map['snippet']['channelTitle'],k=="channel"?y:NetworkImage(x),map['snippet']['channelId'],),
  ...
  factory Item.fromMap2(Map<String, dynamic> map,String y) {
    print('in map2');
    ...
    return Item(
     // videoTitle: map['snippet']['title'],
      ...
      Channel(map['snippet']['channelTitle'],
        NetworkImage(x) ,
        map['snippet']['channelId'],),

      viewCount:2,
      vid: map['snippet']['resourceId']['videoId'],
      title:map['snippet']['title'],
      type: 'video',
