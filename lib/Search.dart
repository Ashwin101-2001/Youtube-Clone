...
class Search extends StatefulWidget {
  ...
  Playlist p;
  //int x;
  Search([this.q,this.s,this.cthumbnail,this.p]);
  @override
  SearchState createState() => SearchState(q,s,cthumbnail,p);
}
...
class SearchState extends State<Search> {
  ...
  //int x;
  SearchState(this.q,this.s,[this.cthumbnail,this.p]);
